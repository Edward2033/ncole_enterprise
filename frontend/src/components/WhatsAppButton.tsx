...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className="fixed z-50 flex h-13 w-13 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40
                 transition-all duration-200 ease-out hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/50
