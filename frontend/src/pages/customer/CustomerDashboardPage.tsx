  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
        ...
        <KpiCard icon={<TrendingUp className="h-5 w-5 text-white" />}    label="Total Spent"   value={loading ? '—' : formatRWF(totalSpent)} gradient="bg-gradient-to-br from-violet-500 to-violet-600"  delay="180ms" />
      </div>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <div className="space-y-3">
          ...
          <QuickAction to="/account/addresses"     icon={<MapPin className="h-5 w-5 text-rose-600" />}       label="Addresses"     desc="Manage delivery addresses"         color="bg-rose-100 dark:bg-rose-900/30"      delay="50ms" />
          <QuickAction to="/account/billing"       icon={<CreditCard className="h-5 w-5 text-blue-600" />}   label="Billing"       desc="View invoices and payments"        color="bg-blue-100 dark:bg-blue-900/30"      delay="100ms" />
          <QuickAction to="/account/notifications" icon={<Bell className="h-5 w-5 text-orange-600" />}       label="Notifications" desc="Manage notification preferences"   color="bg-orange-100 dark:bg-orange-900/30"  delay="150ms" />
        </div>
      </div>
